    ...
    return (
        <>
          <form onSubmit={addPerson}>
            <div>
              name: <input value={props.name} onChange={(event) => {props.nameSetter(event.target.value)}} />
            </div>
            <div>
              number: <input value={props.number} onChange={(event) => {props.numberSetter(event.target.value)}} />
            </div>
            <div>
